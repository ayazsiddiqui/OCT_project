        ...
        function obj = set.kernel(obj,val)
            switch val
                case 'squaredExponential'
                    obj.kernel = kernels.squaredExponential;
                otherwise
                    error('Unknown kernel class')
            end
        end
        ...
        function obj = set.acquisitionFunction(obj,val)
            switch val
                case 'upperConfidenceBound'
                    obj.acquisitionFunction = acquisitionFunctions.upperConfidenceBound;
                    
                case 'expectedImprovement'
                    obj.acquisitionFunction = acquisitionFunctions.expectedImprovement;
                    
                otherwise
                    error('Unknown acquisition function class')
            end
        end
