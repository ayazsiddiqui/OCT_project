...
aeroStruct(1).aeroCentPosVec = -0*obj.reference_point + [...
...
aeroStruct(2).aeroCentPosVec = -0*obj.reference_point + [...
    (tand(obj.wing_sweep)*obj.wing_span/4) + obj.wing_chord*(1 + obj.wing_TR)/8;...
    obj.wing_span/4; tand(obj.wing_dihedral)*obj.wing_span/4];
...
aeroStruct(3).aeroCentPosVec = -0*obj.reference_point + ...
    [obj.h_stab_LE + (obj.h_stab_chord/4);0 ;0];
...
aeroStruct(4).aeroCentPosVec = -0*obj.reference_point + [...
